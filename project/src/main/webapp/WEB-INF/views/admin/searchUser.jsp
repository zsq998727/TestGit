            ...
            <div class="modal-body">
                <form class="form-horizontal" id="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="people_update" name="name" readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
    ...
    <div class="row">
        <div class="col-xs-2" style="height:100%; background: #101010">
            ...
            <ul id="dashboard-menu" class="nav nav-list collapse in">
                <li class="active"><a href="admin_searchUser">查找用户</a></li>
...
<script type="text/javascript">
    ...
    $("#save").click(function () {
        $.ajax({
            url: "savaUser",
            data: {name:$("#people_update").val(), email:$("#inputEmail").val(), type:$("#type").val()},
            type: "POST",
            success: function (result) {
                alert(result.msg)
            }
