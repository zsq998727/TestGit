    ...
    <div class="container">
        <div class="collapse navbar-collapse" >
            <ul class="nav nav-tabs">
                ...
                <li role="presentation" class="active"><a href="lucai">鲁菜</a></li>
...
<div class="container" style="margin-top: 20px;">
    <div class="row" id="row">
        <div class="col-xs-12">
            <h2>鲁菜</h2>
            <p id="introduction">
                即山东菜系，由齐鲁、胶辽、孔府三种风味组成。是宫廷最大菜系。以孔府风味为龙头。鲁菜对其他菜系的产生有重要的影响，
                因此为八大菜系之首。是起源于山东的齐鲁风味，其发源地为山东省淄博市博山区，是中国传统四大菜系（也是八大菜系）
                中唯一的自发型菜系（相对于淮扬、川、粤等影响型菜系而言），是历史最悠久、技法最丰富、难度最高、最见功力的菜系。
            </p>
            <p><strong>特点：</strong>咸鲜为主，火候精湛，精于制汤，善烹海鲜，注重礼仪</p>
            <p><h3>经典菜品：</h3><br>油焖虾——菜品色泽枣红亮丽，味香飘逸，鲜嫩微甜，油润适口，是著名的美味佳肴。<br>
                推荐指数★★★★☆<br>
                糖醋鲤鱼——鲤鱼色泽金黄，外焦里嫩，香甜酸醇，肉味纯正，鲜嫩肥美。<br>
                推荐指数★★★★★
            </p>
        </div>
    </div>
