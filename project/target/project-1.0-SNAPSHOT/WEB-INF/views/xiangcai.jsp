    ...
    <div class="container">
        <div class="collapse navbar-collapse" >
            <ul class="nav nav-tabs">
                ...
                <li role="presentation" class="active"><a href="xiangcai">湘菜</a></li>
...
<div class="container" style="margin-top: 20px;">
    <div class="row" id="row">
        <div class="col-xs-12">
            <h2>湘菜</h2>
            <p id="introduction">
                即湖南菜系，以长沙菜为代表。各地风味统一，主要流行于湖南地区。在中国大部分地区都有湘菜馆，是民间第三大菜系。 油重色浓，
                讲求实惠，一是辣，二是腊。湘菜制作精细， 用料上比较广泛，口味多变，品种繁多；色泽上油重色浓，讲求实惠；品味上注重香辣、
                香鲜、软嫩；制法上以煨、炖、腊、蒸、炒诸法见称。
            </p>
            <p><strong>特点：</strong>口味多变，品种繁多，注重香辣、香鲜、软嫩。</p>
            <p><h3>经典菜品：</h3><br>剁椒鱼头——以鱼头的“味鲜”和剁辣椒的“辣”为一体，风味独具一格。<br>
                推荐指数★★★★☆<br>
                血浆鸭——成品色泽深红，皮肉酥香，酱香浓郁，滋味悠长，醇香可口，色香俱全，低脂不腻，回味无穷。<br>
                推荐指数★★★★★
            </p>
        </div>
    </div>
