    ...
    <div class="container">
        <div class="collapse navbar-collapse" >
            <ul class="nav nav-tabs">
                ...
                <li role="presentation" class="active"><a href="yuecai">粤菜</a></li>
...
<div class="container" style="margin-top: 20px;">
    <div class="row" id="row">
        <div class="col-xs-12">
            <h2>粤菜</h2>
            <p id="introduction">
                即广东菜，由广府、客家、潮汕三种风味组成，在国内、海外影响极大，是国内民间第二大菜系。在国外是中国的代表菜系。 广州菜范围
                包括珠江三角洲和韶关、湛江等地，用料丰富，选料精细，技艺精良，清而不淡，鲜而不俗，嫩而不生，油而不腻。擅长小炒，要求掌握火候和油温恰到好
                处。还兼容许多西菜做法，讲究菜的气势、 档 次。广州菜是粤菜的代表，顺德更被联合国教科文组织授予世界“美食之都”称号。
            </p>
            <p><strong>特点：</strong>注重质和味，口味比较清淡，力求清中鲜、淡中求美。</p>
            <p><h3>经典菜品：</h3><br>广式烤乳猪——色泽红润，形态完整，皮酥肉嫩，肥而不腻，又鲜又嫩，入口奇香。<br>
                推荐指数★★★★★<br>
                盐焗鸡——制法独特，味香浓郁，皮爽肉滑，色泽微黄，皮脆肉嫩，骨肉鲜香，风味诱人。<br>
                推荐指数★★★☆☆<br>
            </p>
        </div>
    </div>
