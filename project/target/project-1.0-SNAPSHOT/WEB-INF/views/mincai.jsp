    ...
    <div class="container">
        <div class="collapse navbar-collapse" >
            <ul class="nav nav-tabs">
                ...
                <li role="presentation" class="active"><a href="mincai">闽菜</a></li>
...
<div class="container" style="margin-top: 20px;">
    <div class="row" id="row">
        <div class="col-xs-12">
            <h2>闽菜</h2>
            <p id="introduction">
                是以福州、闽南、闽西三地区地方风味菜为主形成的菜系。福州菜清鲜、爽淡，偏于甜酸，尤其讲究调汤，另一特色是善于用红糖作配料，
                具有防变质、去腥、增香、生味、调色作用。闽南菜以厦门为代表，同样具有清鲜爽淡的特色， 讲究佐料长于使用辣椒酱、芥末酱等调料。
                闽西位于粤、闽、赣三省交界处，以客家菜为主体，多以山区特有的奇味异品作原料，有浓厚山乡色彩。
            </p>
            <p><strong>特点：</strong>以“香”、“味”见长，有清鲜、和醇、荤香、不腻的风格特色</p>
            <p><h3>经典菜品：</h3><br>佛跳墙——富含营养，可促进发育，美容，延缓衰老，增强免疫力，乃进补佳品。<br>
                推荐指数★★★★★<br>
                醉排骨——令人陶醉，故名之，桔红色，酸甜微辣，外脆里鲜嫩。<br>
                推荐指数★★★☆☆
            </p>
        </div>
    </div>
